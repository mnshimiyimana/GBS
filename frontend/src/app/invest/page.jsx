  ...
  return (
    <div>
      <section>
        ...
        <div className="bg-[#005DAC0D] p-20 rounded-md">
          <h1 className="text-blue text-6xl text-center font-semibold">Invest in Rwanda</h1>
          <p className="text-gray mt-6 text-lg text-justify font-light">
        ...
        <div className="p-32">
          <div>
          <h1 class="text-blue text-5xl font-semibold">Find out more about Rwanda as an outsourcing destination</h1>
          <h4 className="font-medium pt-10">RWANDA GLOBAL BUSINESS SERVICES CASE STUDY & SPECIAL COUNTRY REPORT</h4>
          <p className="text-gray pt-10 font-light  pb-6">
          ...
          <button type="button" class=" hover:drop-shadow-lg  text-blue hover:bg-white border-2 border-blue focus:ring-2 focus:outline-2 focus:ring-blue font-medium rounded-lg text-base px-4 py-3 text-center">Read Report</button>
          </div>
        </div>
